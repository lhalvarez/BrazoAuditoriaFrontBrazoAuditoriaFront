...
class Formulario extends Component {
  ...
  fillForm(){
    ...
    if(partida){
      ...
      if(partida.resultado !== null){
        $('.auditoriaEfectuada').show(500);
        $('.auditoriaNoEfectuada').hide(500);
        $('.estatusText').show(500).text(partida.resultado.estatus);
        $('.estatusSelect').hide(500);
        $('.textObservaciones').val(partida.resultado.observaciones);
      }
    }
  ...
  render(){
    ...
    return(
      <div>
        <div className="alert alert-warning auditoriaEfectuada" hidden>
                    ...
                    <div className="col-md-6">
                      <div className="form-group row">
                        ...
                        <div className="col-sm-8">
                          <select name="estatus" id="estatus" className="form-control input-sm estatusSelect"></select>
                          <b className="estatusText" hidden></b>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="col-lg-12">
                      <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                          <textarea name="" id="observaciones" cols="30" rows="4" className="form-control input-sm textObservaciones"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12">
                      <div className="pull-right auditoriaNoEfectuada">
