                    ...
                    <fieldset className="margin-left">
                      ...
                      <div className="col-md-12">
                        <div className="form-group row">
                          ...
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? detallePartida.prestamo:''} className="form-control input-sm" dir="rtl"  thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.prestamoMaximoSugerido:''} className="form-control input-sm"  dir="rtl" thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>

                          </div>
                          <label htmlFor="prestamoSugerido" className="col-sm-2 col-form-label">Préstamo Sugerido:</label>
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.prestamoSugerido:''} className="form-control input-sm" dir="rtl"  thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.valorMonte:''} className="form-control input-sm" dir="rtl"  thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                          <label htmlFor="valorComercial" className="col-sm-2 col-form-label">Valor comercial:</label>
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.valorComercial:''} className="form-control input-sm"  dir="rtl" thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.avaluoComplementario:''} className="form-control input-sm"  dir="rtl" thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.costoMetal:''} className="form-control input-sm"  dir="rtl" thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                          <label htmlFor="importeGramo" className="col-sm-2 col-form-label">Importe Gramo:</label>
                          <div className="col-sm-4">
                            <NumberFormat disabled="disabled" value={detallePartida? '$ '+detallePartida.importeGramo:''} className="form-control input-sm" dir="rtl"  thousandSeparator={true} decimalScale={2} fixedDecimalScale={true} prefix={'$'}/>
                          </div>
                        </div>
                      </div>
                    </div>
